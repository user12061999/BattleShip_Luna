...
namespace Jacovone
{
    ...
    public class PathMagicEditor : Editor
    {
        ...
        private Vector3 PositionHandle(Vector3 position, Quaternion rotation, bool mini)
        {
            ...
            var fmh_1271_57_638531884895448444 = Quaternion.identity; position = Handles.FreeMoveHandle(position, handleSize * 0.15f, new Vector3(xPresent ? 0.5f : 0f, 0.5f, 0.5f), Handles.RectangleHandleCap);
            Handles.color = color;
            return position;
        }
